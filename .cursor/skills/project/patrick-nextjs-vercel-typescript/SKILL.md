---
name: patrick-nextjs-vercel-typescript
description: >-
  Next.js App Router, TypeScript, Shadcn/Radix/Tailwind, RSC, Vercel KV/middleware,
  and AI SDK RSC patterns. Use when building full-stack Next.js on Vercel with
  TypeScript, server components, or generative UI integrations.
---

# Next.js + Vercel + TypeScript (PatrickJS awesome-cursorrules)

Source: [PatrickJS/awesome-cursorrules — nextjs-vercel-typescript](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/nextjs-vercel-typescript-cursorrules-prompt-file/.cursorrules)
