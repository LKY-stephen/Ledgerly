...
This project vendors a **pointer skill** to [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills): a curated index of 1000+ agent skills from teams (Anthropic, Vercel, Stripe, Cloudflare, etc.) and the community. It is compatible with Cursor, Claude Code, Codex, and similar tools.
