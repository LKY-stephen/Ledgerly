---
name: patrick-python-fastapi
description: >-
  Python, FastAPI, Pydantic v2, and async API conventions. Use when writing or
  reviewing FastAPI routes, schemas, middleware, lifespan, and backend Python in
  this project.
---

# Python FastAPI best practices (PatrickJS awesome-cursorrules)

Source: [PatrickJS/awesome-cursorrules — python-fastapi-best-practices](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/python-fastapi-best-practices-cursorrules-prompt-f/.cursorrules)
