  ...
  const capabilities =
    lang === "zh-CN"
      ...
      : [
          ...
          "For lower-level tax detail, use get_schedule_c_aggregation and get_schedule_se_preview.",
          "",
          "## Evidence And Workflow Inspection",
          "Use list_evidences, list_upload_batches, list_candidate_records, and list_workflow_write_proposals when the user asks about upload, parse, review, or approval state.",
          "",
          "## Tax-Ready Records",
