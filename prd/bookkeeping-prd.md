...
Ledgerly 记账功能是一个面向创作者的移动端、本地优先记账工作区，帮助用户记录收入、费用和发票状态，并形成清晰、可追溯、可继续整理的个人经营账本。
...
2. 验证用户是否愿意在本地优先模式下使用 Ledgerly 进行日常财务整理
...
只要这三件事形成清晰的记录与整理闭环，Ledgerly 的移动端产品基础就算真正立住了。
